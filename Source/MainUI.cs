...
namespace TS4_STBL_Editor
{
    public partial class MainUI : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            stblEditor.InitialDataGridView(dataGridView1);
            stblEditor.ShowDialog();

            if (stblEditor.tempDataGridView.Rows.Count != 0)
            {
                dataGridView1.Rows.Clear();
                dataGridView1.Rows.Add(stblEditor.tempDataGridView.Rows.Count);
                for (int i = 0; i < stblEditor.tempDataGridView.Rows.Count; i++)
                {
                    dataGridView1.Rows[i].Cells[0].Value = stblEditor.tempDataGridView.Rows[i].Cells[0].Value;
                    dataGridView1.Rows[i].Cells[1].Value = stblEditor.tempDataGridView.Rows[i].Cells[1].Value;
                }
            }
